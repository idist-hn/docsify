...
![Trang đăng nhập](../media/registration/login-page.png?v=1.0 ':size=600')
...
![Chọn loại tài khoản](../media/registration/account-type.png?v=1.0 ':size=600')
...
![Form đăng ký](../media/registration/registration-form.png?v=1.0 ':size=600')
...
![Email xác thực](../media/registration/verification-email.png?v=1.0 ':size=600')
...
![Xác thực OTP](../media/registration/otp-verification.png?v=1.0 ':size=600')
...
![Dashboard](../media/registration/dashboard.png?v=1.0 ':size=600')
...
![Quên mật khẩu](../media/registration/forgot-password.png?v=1.0 ':size=600')
